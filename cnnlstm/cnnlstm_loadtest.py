...
def main(argv):
    ...
    x_test = np.transpose(x_test, (0, 2, 1, 3)) # Change Shape
...
###############################################################################
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(total_epochs):
            total_steps = 10
            train_generator = generate_file(test_list, 256)
...
###############################################################################
        ...
        saver.save(sess=sess, save_path='./loadtest/cnnlstm_' 
...
def generate_file(file_list, batch_size):
    ...
    while True:
        for file in file_list:
            ...
            feature = np.transpose(feature, (0, 2, 1, 3)) # Change Shape
            label = h5f['label'][:]
            h5f.close()
            # gc plz..
            i = 0
